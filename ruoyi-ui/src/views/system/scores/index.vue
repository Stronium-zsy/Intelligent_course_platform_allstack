<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="scoresList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="${comment}" align="center" prop="scorer" />
      <el-table-column label="${comment}" align="center" prop="bescorer" />
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除【请填写功能名称】编号为"' + scorers + '"的数据项？').then(function() {
